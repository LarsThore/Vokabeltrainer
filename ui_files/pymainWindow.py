...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.vocabsLearnedLabel.setGeometry(QtCore.QRect(20, 120, 201, 81))
        ...
        self.vocabsLearned.setGeometry(QtCore.QRect(280, 140, 51, 50))
        ...
        self.language2Button = QtWidgets.QPushButton(self.tab1)
        self.language2Button.setGeometry(QtCore.QRect(120, 60, 160, 36))
        self.language2Button.setCheckable(True)
        self.language2Button.setChecked(True)
        self.language2Button.setObjectName("language2Button")
        self.language1Button = QtWidgets.QPushButton(self.tab1)
        self.language1Button.setGeometry(QtCore.QRect(120, 20, 160, 36))
        self.language1Button.setCheckable(True)
        self.language1Button.setChecked(False)
        self.language1Button.setObjectName("language1Button")
        self.languageBothButton = QtWidgets.QPushButton(self.tab1)
        self.languageBothButton.setGeometry(QtCore.QRect(290, 40, 160, 36))
        self.languageBothButton.setCheckable(True)
        self.languageBothButton.setObjectName("languageBothButton")
        self.vocabsLearnedLabel_2 = QtWidgets.QLabel(self.tab1)
        self.vocabsLearnedLabel_2.setGeometry(QtCore.QRect(10, 30, 91, 50))
        self.vocabsLearnedLabel_2.setMinimumSize(QtCore.QSize(0, 50))
        self.vocabsLearnedLabel_2.setMaximumSize(QtCore.QSize(250, 16777215))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.vocabsLearnedLabel_2.setFont(font)
        self.vocabsLearnedLabel_2.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.vocabsLearnedLabel_2.setAlignment(QtCore.Qt.AlignCenter)
        self.vocabsLearnedLabel_2.setWordWrap(True)
        self.vocabsLearnedLabel_2.setObjectName("vocabsLearnedLabel_2")
        ...
        self.addVocButton.setDefault(True)
...
"right answer"))
        ...
        self.language2Button.setText(_translate("MainWindow", "Language2"))
        self.language1Button.setText(_translate("MainWindow", "Language1"))
        self.languageBothButton.setText(_translate("MainWindow", "Both"))
        self.vocabsLearnedLabel_2.setText(_translate("MainWindow", "Ask for:"))
